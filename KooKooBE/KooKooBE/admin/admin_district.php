...
if ($_pgR["act"] == model_District::ACT_ADD)
{
	...
	if (global_common::isCLogin())
	{
		...
		$districID = $_pgR[global_mapping::DistrictD];
...
elseif($_pgR['act'] == model_District::ACT_SHOW_EDIT)
{
	...
	echo global_common::convertToXML($strMessageHeader, array('rs','DistrictID','DistrictName','CityID','Status'), array(1,'DistrictID','DistrictName','CityID','Status'),array(0,1,1,1,1));
	return ;
}
