...
{		   
	...
	*/
	...
	public function insert( $username,$password,$fullname,$birthdate,$address,$phone,$email,$sex,$identity,$roleid,$userrankid,$avatar,$accountid,$isactived,$externalID, $externalType)
	{
		...
		$strSQL = global_common::prepareQuery(self::SQL_INSERT_SL_USER,
				array(self::TBL_SL_USER,null,
                    ...
                    global_common::escape_mysql_string($externalID),
                    global_common::escape_mysql_string($externalType)
                    ));
